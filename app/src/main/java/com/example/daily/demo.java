...
public class demo extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textFinal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                switch(flagFinal){
                    case 0://flag true라면 해당 DB에 있는 내용 text를 조금만 보여준다(text 변수 따로 만들 것.)
                        textFinal.setText("밤은 다시 길고 깊어졌네\n" +
                                "나는 점점 너로 잠 못 들게 돼...");
                        textFinal.setVisibility(View.VISIBLE);
                        flagFinal=1;
                        return;
                    case 1: //flag true라면 해당 DB에 있는 내용 text를 보여준다.
                        //아래는 예시
                        textFinal.setText("밤은 다시 길고 깊어졌네\n" +
                                "나는 점점 너로 잠 못 들게 돼\n" +
                                "글로 적어내긴 어려운 이 기분을\n" +
                        ...
                        return;
                    case 2:
                        Intent intent=new Intent(getApplicationContext(), FinalWritten.class);
